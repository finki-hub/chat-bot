export const messages = {
  ...
  'composer.disclaimer':
    'Не внесувајте лични, доверливи или чувствителни податоци. Разговорите се\u{00A0}користат за подобрување на четботот. Одговорите на четботот може да бидат неточни.',
