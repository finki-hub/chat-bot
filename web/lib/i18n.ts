export const messages = {
  ...
  'feedback.detail': 'Дополнителни детали (изборно)',
  'feedback.dislikePrompt': 'Што не беше во ред со одговорот?',
  'feedback.dislikeTitle': 'Помогнете ни да го подобриме одговорот',
  'feedback.reason.incomplete': 'Нецелосен одговор',
  'feedback.reason.incorrect': 'Неточен одговор',
  'feedback.reason.off_topic': 'Одговор надвор од темата',
  'feedback.reason.other': 'Друго',
  'feedback.reason.outdated': 'Застарени информации',
  'feedback.submit': 'Испрати повратна информација',
