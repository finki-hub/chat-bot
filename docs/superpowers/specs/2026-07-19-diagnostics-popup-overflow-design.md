...
- Add an end-to-end regression that renders the complete diagnostics payload at a small viewport, opens the popup through its existing trigger, and proves the popup remains within the viewport while overflowing content can scroll to the final row.
