...
def post_fork(_server: object, _worker: object) -> None:
    ...
    from app.utils.posthog_client import init_posthog  # ruff: ignore[PLC0415] -- client must initialize after fork
...
def worker_exit(_server: object, _worker: object) -> None:
    from app.utils.posthog_client import shutdown_posthog  # ruff: ignore[PLC0415] -- hook runs in the worker process
